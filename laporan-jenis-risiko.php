              ...
              <table class="table table-bordered text-center">
                <thead>
                  <tr>
                    ...
                    <th class="text-light" style="background-color: #00529c;" scope="col" >Jenis Risiko</th>
                    <th class="text-light" style="background-color: #00529c;" scope="col" >Jumlah</th>
                    <th class="text-light" style="background-color: #00529c;" scope="col" >Persentase (%)</th>
                  </tr>

                  <tr>
                    <td scope="col" >1</td>
                    <td scope="col" >Resiko Kredit</td>
                    <td scope="col" >2</td>
                    <td scope="col" >50</td>
                  </tr>
                  ...
                  <tr>
                    <td scope="col" >3</td>
                    <td scope="col" >Resiko Likuiditas</td>
                    <td scope="col" >0</td>
                    <td scope="col" >0</td>
                  </tr>
                  ...
                  <tr>
                    <td scope="col" >4</td>
                    <td scope="col" >Resiko Operasional</td>
                    <td scope="col" >0</td>
                    <td scope="col" >0</td>
                  </tr>
                  ...
                  <tr>
                    <td scope="col">6</td>
                    <td scope="col">Resiko Reputasi</td>
                    <td scope="col">0</td>
                    <td scope="col">0</td>
                  </tr>
                  ...
                  <tr>
                    <td scope="col">7</td>
                    <td scope="col">Resiko Stratejik</td>
                    <td scope="col">0</td>
                    <td scope="col">0</td>
                  </tr>
                  ...
                  <tr>
                    <td scope="col">8</td>
                    <td scope="col">Resiko Kepatuhan</td>
                    <td scope="col">0</td>
                    <td scope="col">0</td>
                  </tr>
                  ...
                  <tr>
                    <td scope="col">9</td>
                    <td scope="col">Resiko Intra Group</td>
                    <td scope="col">0</td>
                    <td scope="col">0</td>
                  </tr>
